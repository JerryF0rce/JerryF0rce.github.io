...
$(document).ready(function(n){n("#my-menu").mmenu({extensions:["pagedim-black","effect-menu-slide"],navbar:{title:'<a href="#"><span class="logo1">Pura</span> <br><span class="logo2">Agency.</span></a>'},offCanvas:{position:"right"},pageScroll:!0});var e=n(".hamburger"),a=n("#my-menu").data("mmenu");e.on("click",function(){a.open()}),a.bind("open:finish",function(){setTimeout(function(){e.addClass("is-active")},100)}),a.bind("close:finish",function(){setTimeout(function(){e.removeClass("is-active")},100)})});